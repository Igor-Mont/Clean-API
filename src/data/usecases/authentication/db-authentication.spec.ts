...
import { LoadAccountByEmailRepository, AuthenticationModel, AccountModel, HashCompare, Encrypter, UpdateAccessTokenRepository } from './db-authentication-protocols'
